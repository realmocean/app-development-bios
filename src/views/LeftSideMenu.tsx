    ...
    const menu = [
        {
            ...
            view: () => (
                ...
                HStack(
                    UIImage(MainLogo).width(40).height(40)
                )
                //)
